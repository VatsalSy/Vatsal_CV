...
\item[--] (Oct.~26, 22) \emph{Drop impact forces} \\
  CFSM Seminar Series (Virtual). \href{https://www.youtube.com/live/enTMAucwUDs?si=Dm-IJ3A0o7AhMc2T}{[Video]}.
...
\begin{itemize}[leftmargin=1.25em]
\item[--] (Nov.~24) \emph{Dissipative anomaly in sliding drops}, APS-DFD, Salt Lake City, USA.
\item[--] (Sep.~24) \emph{Drop Impact Forces}, 12th Liquid Matter Conf., Mainz, Germany.
\item[--] (Sep.~24) \emph{A unifying approach for drop impact dynamics on rigid surfaces}, 1st EFDC, Aachen.
\item[--] (Apr.~24) \emph{Bursting bubbles in a viscoelastic medium}, European Rheology Conf., Leeds, UK.
\item[--] (Nov.~23) \emph{A unifying approach for droplet impact forces}, APS-DFD, Washington, DC, USA. \href{https://youtu.be/3S_hwkMCx6U?si=01tvC4RHCoga62bC}{[Video]}.
\item[--] (Nov.~22) \emph{Impact forces of water drops.}, APS-DFD, Indianapolis, USA. \href{https://youtu.be/U0g67zV70hw}{[Video]}.
\item[--] (Jul.~23) \emph{Viscous free-surface flows}, Basilisk/Gerris Meeting, Paris, France.
\item[--] (Sep.~22) \emph{When does an impacting drop stop bouncing?}, EFMC14, Athens, Greece.
\item[--] (Jan.~22) \emph{How much force is required to play ping-pong with water droplets?}, Physics@Veldhoven. \href{https://youtu.be/wmEYeQRPi0Q?si=u8Ex64dYLHQ8TxCE}{[Video]}.
\item[--] (Nov.~21) \emph{Viscous dissipation dictates Taylor-Culick type retractions}, APS-DFD, Phoenix. \href{https://youtu.be/d0tMlpbMIqY?si=V-7Lh5g-zj1j7al6}{[Video]}.
\item[--] (Dec.~20) \emph{Bursting Bubble in a Viscoplastic medium}, International Congress on Rheology (virtual). \href{https://youtu.be/52D6nfaHbYg?si=lE3oQGiMZe3UCT6j}{[Video]}.
\item[--] (Nov.~20) \emph{When does a viscous drop stop bouncing?}, APS-DFD (virtual). \href{https://youtu.be/9JCV9JFwr2A?si=Vs1ljwdmZrzHUOXX}{[Video]}.
\item[--] (Feb.~20) \emph{Jumping \& Bouncing Drops \& Bubbles}, Max Planck meeting, Mainz.
\item[--] (Nov.~19) \emph{Droplet Encapsulation}, APS-DFD, Seattle.
\item[--] (Sep.~19) \emph{Bursting Bubbles: from Champagne to Mudpots}, VPF8, Cambridge, UK.
\item[--] (Aug.~19) \emph{Impinging drop lifts a sessile drop}, 9th 4U Summer School, Denmark.
\item[--] (May~16) \emph{On gas-liquid entrainment by impinging jet}, ICMF9, Florence, Italy.
\end{itemize}
